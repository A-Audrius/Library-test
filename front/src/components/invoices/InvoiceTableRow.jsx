...
const InvoiceTableRow = ({ invoice }) => {
  ...
  return (
    <div className="bg-indigo-200 dark:bg-indigo-950 rounded-lg px-6 py-6 my-2 md:flex items-center justify-between gap-4 md:min-w-[600px]">
      <p className="font-semibold  dark:text-gray-300">{invoice_id}</p>
      <p className="text-sm text-gray-800 dark:text-gray-400">{date}</p>

      <p className=" text-gray-800 dark:text-gray-400 text-sm">{customer_name}</p>

      <p className="font-bold text-lg text-gray-800 dark:text-gray-400">£{amount}</p>
